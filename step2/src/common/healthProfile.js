...
const healthProfile = [
    ...
    {label:'既往歴',question:'既往歴',placeholder:'',error:'',text:'', checked:'ture'},
    {label:'接種回数',question:'ワクチンの接種回数を選択してください',placeholder:'',error:'',text:'', checked:'ture'},
    {label:'ワクチンの種類',question:'ワクチンの種類を入力してください',placeholder:'',error:'',text:'', checked:'ture'},
